...
export interface ProAutoComplete<O extends FieldValues, V extends string | number>
...
const ProFormSelectEditAutocomplete = <
  O extends FieldValues,
  V extends string | number
>(
  props: ProAutoComplete<O, V>
) => {
  const {
    name,
    label,
...
export default ProFormSelectEditAutocomplete;
