...
const schema = Validation.shape({
  ...
  reasonCare: Validation.string().optional().default(null),
  formality: Validation.select(0).optional().default(null),
});
