...
const useTableColumns = (props: Props) => {
  const { pageNumber, pageSize, onSetAll } = props;
    ...
    return [
      ...
      columnHelper.accessor('quantity', {
        ...
        header: () => {
          return (
            <>
              <Typography>{HEAD_CELLS.quantity}</Typography>
              <SkipNextIcon
                sx={{ cursor: 'pointer' }}
                color="primary"
                onClick={onSetAll()}
      ...
      columnHelper.accessor('confirmQuantity', {
        id: 'confirmQuantity',
        size: 150,
        header: () => HEAD_CELLS.confirmQuantity,
        enableSorting: false,
        cell: (context) => {
          return (
            <EditableCell
        ...
        meta: {
          title: HEAD_CELLS.confirmQuantity,
          align: 'center',
          editable: true,
          type: 'text',
        },
